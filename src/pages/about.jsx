...
function Overview(){
    return (
        <div>
            <h2>About Me</h2>
            <p>My name is Tong Yu Hei, but you can call me John. I am a graduate from City University of Hong Kong with a major in Creative Media. I was born in Hong Kong and currently studying Computer Studies at Langara College in Canada.</p>
